...
class Persistencia_factory_mySql(Persistencia_factory.Persistencia_factory):
    def __init__(self, host, usuari, paraula_pas, base_dades):
        self.host = host
        self.usuari = usuari
    ...
    def get_Persistencia_usuari_factory(self):
        return Persistencia_usuari_mySql.Persistencia_usuari_mySql(self.host, self.usuari, self.paraula_pas, self.base_dades)
