...
class App_llista_compra:
    def __init__(self):
        self.configurador = Configurador.Configurador(os.path.join(os.path.dirname(__file__), FITXER_CONFIGURACIO))
        self.usuaris = []
    ...
    def create_usuari(self, user, password):
        ...
        nou_usuari = Usuari.Usuari(self.configurador, None, user, password_hash)
